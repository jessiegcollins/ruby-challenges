...
def determine_message(sum)
	...
	when 9
		...
		message = "oh. you done screwed something up."
	end
end

puts "Enter your birthdate in MMDDYYYY format."
birthdate = gets
sum = determine_path_number(birthdate)
message = determine_message(sum)
puts "Your birthpath number is #{sum} and this means: #{message}"
